...
The Generalized Additive Model (GAM) provided a nuanced and interpretable answer to our second research question, isolating the effect of the original equity offer.

The model revealed a strong, non-linear relationship between the equity offered and the probability of securing a deal. Contrary to a simple "more is better" assumption, the results indicate a clear optimal range.
...
**Limitations:**\
The main limitation is that the highly accurate Random Forest model uses post-deal information, making it descriptive rather than predictive for new pitches. Furthermore, neither model can capture crucial qualitative factors like the entrepreneur's presentation skills or the negotiation dynamics.
